...
if [ -n "$bump" ]; then
  ...
  modules=( cli core guardrail java-async-http java-dropwizard java-spring-mvc java-support scala-akka-http scala-dropwizard scala-endpoints scala-http4s scala-support )
