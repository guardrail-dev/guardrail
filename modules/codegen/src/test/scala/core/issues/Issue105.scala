    ...
    val companion = q"""
      object Foo {
        implicit val encodeFoo: _root_.io.circe.Encoder.AsObject[Foo] = {
          ...
          _root_.io.circe.Encoder.AsObject.instance[Foo](a => _root_.io.circe.JsonObject.fromIterable(Vector(("nonEmptyString", a.nonEmptyString.asJson), ("positiveLong", a.positiveLong.asJson)))).mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
        }
