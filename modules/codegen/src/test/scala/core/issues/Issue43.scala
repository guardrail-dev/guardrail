      ...
      val companion = q"""
        object Cat {
          implicit val encodeCat: Encoder.AsObject[Cat] = {
            ...
            new Encoder.AsObject[Cat] { final def encodeObject(a: Cat): JsonObject = JsonObject.fromIterable(Vector(("name", a.name.asJson), ("huntingSkill", a.huntingSkill.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
      ...
      val companion = q"""
        object Dog {
          implicit val encodeDog: Encoder.AsObject[Dog] = {
            val readOnlyKeys = Set[String]()
            new Encoder.AsObject[Dog] { final def encodeObject(a: Dog): JsonObject = JsonObject.fromIterable(Vector(("name", a.name.asJson), ("packSize", a.packSize.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
      ...
      val companion = q"""
        object PersianCat {
          implicit val encodePersianCat: Encoder.AsObject[PersianCat] = {
            val readOnlyKeys = Set[String]()
            new Encoder.AsObject[PersianCat] { final def encodeObject(a: PersianCat): JsonObject = JsonObject.fromIterable(Vector(("name", a.name.asJson), ("huntingSkill", a.huntingSkill.asJson), ("wool", a.wool.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
    ...
    it("should generate right companion object") {
      val companion = q"""
        object PersianCat {
          implicit val encodePersianCat: Encoder.AsObject[PersianCat] = {
            val readOnlyKeys = Set[String]()
            new Encoder.AsObject[PersianCat] { final def encodeObject(a: PersianCat): JsonObject = JsonObject.fromIterable(Vector(("catBreed", a.catBreed.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
    ...
    it("should generate right companion object") {
      val companion = q"""
        object Cat {
          implicit val encodeCat: Encoder.AsObject[Cat] = {
            val readOnlyKeys = Set[String]()
            new Encoder.AsObject[Cat] { final def encodeObject(a: Cat): JsonObject = JsonObject.fromIterable(Vector(("wool", a.wool.asJson), ("catBreed", a.catBreed.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
