    ...
    val companion = q"""
      object PropRef {
        implicit val encodePropRef: _root_.io.circe.Encoder.AsObject[PropRef] = {
          ...
          _root_.io.circe.Encoder.AsObject.instance[PropRef](a => _root_.io.circe.JsonObject.fromIterable(Vector(("param", a.param.asJson), ("array", a.array.asJson), ("arrayArray", a.arrayArray.asJson)))).mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
        }
