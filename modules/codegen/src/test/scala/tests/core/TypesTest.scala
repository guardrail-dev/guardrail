      ...
      object Types {
        ...
        object Nested {
          implicit val encodeNested: Encoder.AsObject[Nested] = {
            val readOnlyKeys = Set[String]()
            new Encoder.AsObject[Nested] { final def encodeObject(a: Nested): JsonObject = JsonObject.fromIterable(Vector(("prop1", a.prop1.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
        ...
        object NestedArray {
          implicit val encodeNestedArray: Encoder.AsObject[NestedArray] = {
            val readOnlyKeys = Set[String]()
            new Encoder.AsObject[NestedArray] { final def encodeObject(a: NestedArray): JsonObject = JsonObject.fromIterable(Vector(("prop1", a.prop1.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
  ...
  test("Generates from composed schema") {
    ...
    val companion = q"""
      object Types {
        implicit val encodeTypes: Encoder.AsObject[Types] = {
          val readOnlyKeys = Set[String]()
          new Encoder.AsObject[Types] { final def encodeObject(a: Types): JsonObject = JsonObject.fromIterable(Vector(("composed", a.composed.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
        }
        ...
        object Composed {
          implicit val encodeComposed: Encoder.AsObject[Composed] = {
            val readOnlyKeys = Set[String]()
            new Encoder.AsObject[Composed] { final def encodeObject(a: Composed): JsonObject = JsonObject.fromIterable(Vector(("string", a.string.asJson), ("int", a.int.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
    ...
    val companion = q"""
      object First {
        implicit val encodeFirst: Encoder.AsObject[First] = {
          val readOnlyKeys = Set[String]()
          new Encoder.AsObject[First] { final def encodeObject(a: First): JsonObject = JsonObject.fromIterable(Vector(("Second", a.Second.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
        }
        ...
        object Second {
          implicit val encodeSecond: Encoder.AsObject[Second] = {
            val readOnlyKeys = Set[String]()
            new Encoder.AsObject[Second] { final def encodeObject(a: Second): JsonObject = JsonObject.fromIterable(Vector(("Third", a.Third.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
          ...
          object Third {
            implicit val encodeThird: Encoder.AsObject[Third] = {
              val readOnlyKeys = Set[String]()
              new Encoder.AsObject[Third] { final def encodeObject(a: Third): JsonObject = JsonObject.fromIterable(Vector(("Fourth", a.Fourth.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
            }
    ...
    val companion =
      q"""
        object Second {
          implicit val encodeSecond: Encoder.AsObject[Second] = {
            val readOnlyKeys = Set[String]()
            new Encoder.AsObject[Second] { final def encodeObject(a: Second): JsonObject = JsonObject.fromIterable(Vector(("value", a.value.asJson), ("nested", a.nested.asJson))) }.mapJsonObject(_.filterKeys(key => !(readOnlyKeys contains key)))
          }
