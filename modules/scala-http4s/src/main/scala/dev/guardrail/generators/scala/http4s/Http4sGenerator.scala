...
class Http4sGeneratorLoader extends FrameworkGeneratorLoader {
  ...
  val apply   = ModuleLoadResult.forProduct1(FrameworkGeneratorLoader.label -> Seq(Http4sVersion.mapping))(_ => Http4sGenerator())
}
...
class Http4sGenerator private extends FrameworkTerms[ScalaLanguage, Target] {
  ...
  def lookupStatusCode(key: Tracker[String]): Target[(Int, scala.meta.Term.Name)] =
    key.unwrapTracker match {
      ...
      case "103" => Target.pure((103, q"EarlyHints"))
      ...
      case "421" => Target.pure((421, q"MisdirectedRequest"))
      ...
      case "425" => Target.pure((425, q"TooEarly"))
